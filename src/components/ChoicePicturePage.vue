<template>
  <ion-header>
    ...
    <ion-title>Choice Picture</ion-title>
    </ion-toolbar>
  </ion-header>
...
<script >
    ...
    import { IonHeader, IonTitle, IonToolbar, IonContent, IonButtons, IonBackButton, IonRadioGroup, IonRadio, IonItem} from '@ionic/vue';
